...
class TreeMaintenanceListScreen extends StatefulWidget {
  ...
  State<TreeMaintenanceListScreen> createState() =>
      _TreeMaintenanceListScreenState();
}
...
class _TreeMaintenanceListScreenState extends State<TreeMaintenanceListScreen> {
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) => _buildTreeCard(
                              context, plantedTrees[index], index),
  ...
  */
  ...
  Widget _buildTreeCard(
      BuildContext context, PlantedTreeModel treeData, int index) {
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                _openMapsApp(
                                    context,
                                    treeData.location.coordinates[1],
                                    treeData.location.coordinates[0]);
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
