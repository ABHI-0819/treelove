...
import 'package:treelove/common/repositories/profile_repository.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _profileTile(
    ...
    return InkWell(
      onTap: () => _openEditSheet(context, title, field, value),
      child: Padding(
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
            ...
            child: Icon(Icons.logout, size: 20, color: color)),
        title: Text(
          title,
