      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<InquiryBloc, ApiState<dynamic, ResponseModel>>(
            builder: (context, state) {
              final isSubmitLoading = state is ApiLoading;
              return SizedBox(
                width: double.infinity,
                child: ElevatedButton(
                  onPressed: isSubmitLoading ? null : _submitSelection,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: isSubmitLoading ? AppColor.grey : AppColor.primary,
                    foregroundColor: AppColor.white,
